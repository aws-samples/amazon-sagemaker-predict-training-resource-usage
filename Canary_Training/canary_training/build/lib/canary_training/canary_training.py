...
class CanaryTrainingKickoff:
		...
		def copy_file_to_s3(self,the_file=None,s3_uri=None):
			...
			os.system(the_cmd)
			return()
		def kick_off_canary_training(self,estimators_list=None,manifest_training_inputs_list=None,training_channels_list=['train','validation'],
			estimator_args=None,
...
class CanaryTrainingEasyUse():
	...
	def prepare_canary_training_data_easy(self):
	...
	def kick_off_canary_training_easy(self):
		submitted_jobs_information=self.ctk.kick_off_canary_training(estimators_list=self.estimators_list,
                                                        ...
                                                        #estimator_kwarks={"wait":True} #uncomment to run serially                                                     
                                                       )
		self.ctk.copy_canary_training_job_info_to_s3(all_jobs_l=submitted_jobs_information)

	def get_predicted_resource_consumption_easy(self):
